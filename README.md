...
The project contains multiple analytics notebooks. The easiest way to run them consistently is via the provided Docker image:
...
```bash
git clone https://github.com/martin-prillard/data_science_cookbook
cd data_science_cookbook
...
1. **Build the image**
```bash
docker build -t data_science_cookbook .
```
